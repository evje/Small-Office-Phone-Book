...
namespace SOPB.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Delete(string username)
        {
            ...
            if (user != null)
            {
                if (RoleManager.RoleExists(user.Roles.ToString()) && !UserManager.IsInRole(user.Id, user.Roles.ToString()))
                {
                    await UserManager.RemoveFromRoleAsync(user.Id, user.Roles.ToString());
                }
